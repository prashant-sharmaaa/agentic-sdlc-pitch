...
def test_sc004(playwright):
    ...
    try:
        ...
        element_0 = page.locator("internal:role=textbox[name=\"Search Product\"i]")
        element_0.click()
        element_0.fill("Blue Top")
        page.wait_for_timeout(500)
        page.keyboard.press('Enter')
        page.wait_for_timeout(500)
        page.wait_for_timeout(500)
        set_test_status(page, 'passed', 'SC-004 passed')

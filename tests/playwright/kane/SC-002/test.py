...
capabilities = {
    ...
    'LT:Options': {
        ...
        'name': 'SC-002: Cart dropdown shows item names and prices',
...
def test_sc002(playwright):
    ...
    try:
        ...
        _loc_1 = page.locator("internal:role=button[name=\"Continue Shopping\"i]")
        _loc_1.click()
        page.mouse.click(1015, 39)
        page.wait_for_timeout(500)
        page.wait_for_timeout(500)
        set_test_status(page, 'passed', 'SC-002 passed')

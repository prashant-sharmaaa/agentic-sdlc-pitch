...
capabilities = {
    ...
    'LT:Options': {
        ...
        'name': 'SC-007: Category filter narrows product list',
...
def test_sc007(playwright):
    ...
    try:
        ...
        page.mouse.click(433, 590)
        page.mouse.click(441, 631)
        page.wait_for_timeout(500)
        page.wait_for_timeout(500)
        set_test_status(page, 'passed', 'SC-007 passed')

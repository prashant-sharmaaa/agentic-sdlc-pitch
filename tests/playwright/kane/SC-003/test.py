...
def test_sc003(playwright):
    ...
    try:
        ...
        _loc_1 = page.locator("internal:role=link[name=\" Products\"i]")
        _loc_1.click()
        page.mouse.click(823, 896)
        _loc_2 = page.locator("internal:role=link[name=\"View Cart\"i]")
        _loc_2.click()
        page.mouse.click(1478, 423)
        page.wait_for_timeout(500)
        page.wait_for_timeout(500)
        set_test_status(page, 'passed', 'SC-003 passed')
